    ...
    public class ClienteController : Controller
    {
        ...
        public JsonResult Incluir(ClienteModel model)
        {
            ...
            else
            {
                if (bo.VerificarExistencia(model.CPF))
                    return Json("Este CPF já consta cadastrado");
                ...
                foreach (BeneficiarioModel bm in model.Beneficiarios)
                {
        ...
        public JsonResult Alterar(ClienteModel model)
        {
            ...
            else
            {
                ...
                List<Beneficiario> BeneficiariosCadastrados = boBenef.Listar(model.Id);
                foreach(Beneficiario b in BeneficiariosCadastrados)
                {
                    BeneficiarioModel BeneficiarioEncontrado = model.Beneficiarios.Where(x => x.Id == b.Id).FirstOrDefault();
