...
$(document).ready(function () {
    ...
    if (obj) {
        ...
        obj.Beneficiarios.forEach(function (Beneficiario, i) {
            AdicionarBeneficiarioLista(Beneficiario.Cpf, Beneficiario.Nome, Beneficiario.Id);
        })
    }
...
function AdicionarBeneficiarioLista(CpfBeneficiario, NomeBeneficiario, Codigo) {

    if (!Codigo)
        Codigo = "Temp" + Date.now().toString();
